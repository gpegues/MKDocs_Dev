...
## Overview
On March 31, 2024, a new Teams client will be rolled out for users who are still on classic Teams, installing the new Teams client for them and uninstalling the classic Teams client. After this time, classic Teams will be unavailable. As part of this process in the coming weeks, individuals using the Classic Teams Client can expect the following items to occur.
...
![Image1](https://learn.microsoft.com/en-us/microsoftteams/media/teams-client-eol-switch-banner.png)
